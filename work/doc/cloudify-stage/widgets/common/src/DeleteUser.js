/**
 * Created by woody on 29/10/2019.
 */
...
class DeleteUser extends React.Component {
    ...
    constructor(props,context) {
        ...
        this.state = DeleteUser.initialState(props);
    }
    ...
    componentDidUpdate(prevProps) {
        if (!prevProps.open && this.props.open) {
            ...
            actions.doGetBlueprints().then((blueprints) => {
                this.setState({...DeleteUser.initialState(this.props), blueprints});
            }).catch((err)=> {
            ...
            <Modal open={this.props.open} onClose={()=>this.props.onHide()} className="updateDeploymentModal">
                ...
                <Modal.Content>
                    <Form loading={this.state.loading} errors={this.state.errors} scrollToError
                        ...
                        <Form.Field>
                            <Form.Checkbox label="强制执行" name="force" toggle
                ...
                <Modal.Actions>
                    ...
                    <ApproveButton onClick={this.onUpdate.bind(this)} disabled={this.state.loading} content="删除" icon="edit" color="green" />
