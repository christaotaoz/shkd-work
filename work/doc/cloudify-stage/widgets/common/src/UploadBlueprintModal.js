            ...
            <div>
                <Modal open={this.props.open} onClose={this.props.onHide} className="uploadBlueprintModal">
                    ...
                    <Modal.Actions>
                        ...
                        <ApproveButton onClick={this.uploadBlueprint.bind(this)} disabled={this.state.loading} content="上传" icon="upload" color="green"/>
                    </Modal.Actions>
                </Modal>
            </div>
        );
