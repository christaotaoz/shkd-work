...
class UploadPluginForm extends React.Component {
    ...
    static defaultProps = {
        wagonUrl: '',
        wagonFile: null,
        wagonPlaceholder: '请提供插件的wagon文件URL或者点击浏览来选择文件',
        yamlUrl: '',
        yamlFile: null,
        yamlPlaceholder: '请提供插件的YAML文件URL或者点击浏览来选择文件',
        errors: {},
        loading: false,
        wrapInForm: true,
    ...
    render() {
        ...
        const formFields = [
            <Form.Field label="Wagon文件" required={this.props.addRequiredMarks} key='wagon'
            ...
            ,
            <Form.Field label="YAML 文件" required={this.props.addRequiredMarks} key='yaml'
