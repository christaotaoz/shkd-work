        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="时间戳" name="timestamp" width="10%"
                                      show={fieldsToShow.indexOf('Timestamp') >= 0} />
                    <DataTable.Column label="类型" name="event_type"
                                      show={fieldsToShow.indexOf('Type') >= 0} />
                    <DataTable.Column label="模版" name="blueprint_id"
