...
Stage.defineWidget({
    ...
    initialConfiguration: [
        ...
        {id: 'nodeFilter', name: '节点过滤器',  description: '根据节点过滤来减少显示的度量', type: Stage.Basic.GenericField.CUSTOM_TYPE,
        ...
        {id: 'charts', name: 'Charts table',  description: 'Charts configuration table', default: '', type: Stage.Basic.GenericField.CUSTOM_TYPE,
         component: Stage.Basic.Form.Table, rows: 5, columns: [
            {name: 'metric', label: '度量', default: '', type: Stage.Basic.GenericField.CUSTOM_TYPE,
             component: Stage.Basic.MetricFilter, description: '将在图表上显示的度量数据', filterContextName: 'nodeFilter'},
