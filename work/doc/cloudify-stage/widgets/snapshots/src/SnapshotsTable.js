...
export default class extends React.Component {
    ...
    render() {
        const NO_DATA_MESSAGE = '当前没有快照。 点击 "创建" 生成快照。';
        ...
        return (
            <div className="snapshotsTableDiv">
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="名称" name="id" width="40%"/>
                    <DataTable.Column label="创建时间" name="created_at" width="20%"/>
                            ...
                            return (
                                <DataTable.Row key={item.id} selected={item.isSelected} onClick={this._selectSnapshot.bind(this, item)}>
                                    ...
                                    <DataTable.Data className="center aligned rowActions">
                                        <Icon name='undo' title="恢复" bordered disabled={!isSnapshotUseful} link={isSnapshotUseful}
