...
export default class extends React.Component {
    ...
    _createDeployment(){
        ...
        //获取蓝图的初始化参数
        actions.doGetFullBlueprintData({id: 'huaweiSwitch'}).then((blueprint)=>{
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button color='green' icon='rocket' content='交换机初始化配置' labelPosition='left' className='widgetButton'
