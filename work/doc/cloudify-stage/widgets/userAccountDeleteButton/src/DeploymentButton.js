...
export default class extends React.Component {
    ...
    _createDeployment(){
        ...
        //获取蓝图的初始化参数
        actions.doGetFullBlueprintData({id: 'delete'}).then((blueprint)=>{
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button color='green' icon='rocket' content='删除用户' labelPosition='left' className='widgetButton'
