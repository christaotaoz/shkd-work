    ...
    render() {
        ...
        return (
            <div>
                ...
                <Button className="widgetButton" color="blue" icon="id card" labelPosition='left' disabled={_.isEmpty(deploymentId) || this.state.loading}
                        onClick={this._showModal.bind(this, DeploymentActionButtons.EDIT_ACTION)}
                        content="新增用户账号" id="updateDeploymentButton"/>
