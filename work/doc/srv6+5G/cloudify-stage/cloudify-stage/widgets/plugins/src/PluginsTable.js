...
export default class extends React.Component {
    ...
    render() {
        const NO_DATA_MESSAGE = '当前没有插件。 点击 "上传" 添加插件。';
        ...
        return (
            <div>
                ...
                <DataTable fetchData={this.fetchGridData.bind(this)}
                    ...
                    <DataTable.Column label="包名" name="package_name" width="20%"/>
                    ...
                    <DataTable.Column label="上传时间" name="uploaded_at" width="15%"/>
                    <DataTable.Column label="创造者" name='created_by' width="15%"/>
                    ...
                    <DataTable.Action>
                        <Button content='上传' icon='upload' labelPosition='left' onClick={this._showUploadModal.bind(this)}/>
                    </DataTable.Action>
