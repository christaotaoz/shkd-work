...
#upload_url = 'https://'+ host +'/cgi-bin/Maintain/appinstall'
#resp=requests.post(
#    upload_url, verify=False,files = files
#)
#print resp.headers
#print resp.status_code
#print resp.text
upload_url = 'https://'+ host +'/cgi-bin/Maintain/appinstall?action=upload'
resp=requests.post(
...
print resp.status_code
print resp.text
import_url = 'https://'+ host +'/cgi-bin/Maintain/appinstall?action=install'
resp = requests.get(
